...
![Architecture.](deployable-architecture-observability.svg "Architecture"){: caption="Figure 1. Architecture diagram" caption-side="bottom"}{: external download="deployable-architecture-observability.svg"}
