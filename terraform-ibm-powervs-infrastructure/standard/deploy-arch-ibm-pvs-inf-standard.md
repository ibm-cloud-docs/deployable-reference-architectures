...
![Architecture diagram for 'Power Virtual Server with VPC landing zone' - variation 'Standard'](deploy-arch-ibm-pvs-inf-standard.svg "Architecture diagram"){: caption="Single-zone PowerVS workspace accessible over secure landing zone" caption-side="bottom"}{: external download="deploy-arch-ibm-pvs-inf-standard.svg"}

## Design requirements
{: #standard-design-requirements}
![Design requirements for 'Power Virtual Server with VPC landing zone' - variation 'Standard'.](heat-map-deploy-arch-ibm-pvs-inf-standard.svg "Design requirements"){: caption="Scope of the solution requirements" caption-side="bottom"}
